...
const TIERS = ['Apex', 'A-Tier', 'Select', 'Prime', 'Premier', 'Essential', 'Essential 2018-2020', 'Essential 2021-2022', 'Essential 2023', 'Essential 2024-2025', 'Core', 'Core 2018-2020', 'Core 2021-2022', 'Core 2023', 'Core 2024-2025', 'Data Leads']
...
export default async function AdminLeadsPage() {
  ...
  const TIER_STYLES: Record<string, { badge: string; bar: string }> = {
    ...
    'Essential 2024-2025': { badge: 'bg-[#2a2a2a] text-gray-300', bar: 'bg-gray-400' },
    'Core 2024-2025': { badge: 'bg-[#4a3a00] text-yellow-300', bar: 'bg-yellow-500' },

...
export const TIER_INFO: Record<string, { year: string; description: string }> = {
  ...
  Core:      { year: 'Complete · 18+ mo', description: 'Complete leads — the full client profile was captured when the lead was generated. Roughly 18+ months old.' },
  Essential: { year: 'Partial · 18+ mo',  description: 'Partial leads — only some client details were captured when the lead was generated. Roughly 18+ months old.' },
